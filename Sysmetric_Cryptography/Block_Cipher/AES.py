...
if __name__ == "__main__":
    key = b'wvgitnmgwnk2n46d'
    aes = AES(key=key)
    enc = b'e6ce89c8cfc5f5c9d2d9c091ce7faccce9cfb7c096d4ea92e2d7df84cba5ae93a6cabe97dfcef0c9b7e1ae6bc4b165dbceed9293d68cedc3a3da94a5aab2b5a7'
    dec = aes.AES_decrypt("AES_ECB", enc)
    print(dec)